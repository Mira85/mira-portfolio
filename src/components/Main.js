        ...
        <div className="intro" style={{ backgroundImage: "url(/images/background-print.png)" }} >
            ...
            <div className="introWrapper">
                ...
                <Modal className="modalArea" show={show.experience} onHide={handleClose}>
                    ...
                    <Modal.Body className="modalBody">
                        <div className="smallScreenProjects">
                            {projectsArr.map((object, arrayIdx) => {
                                return (
                                    <Card className="smallProjectCard" key={arrayIdx}  >
                                        ...
                                        <Card.Body className="smallScrnCardBody">
                                            ...
                                            <div className="projectIcons">
                                                <a href={object.github} target="_blank" rel="noreferrer nofollow"><i className="bi bi-github" style={{ fontSize: '16px', color: '#E0AAFF' }}> </i></a>
                                                <a href={object.viewProject} target="_blank" rel="noreferrer nofollow">  <i className="bi bi-eye-fill" style={{ fontSize: '16px', color: '#E0AAFF' }}></i></a>
                        ...
                        <div className="projectArea">
                            {projectsArr.map((object, arrayIdx) => {
                                return (
                                    <Card className="projectCard" key={arrayIdx} style={{ maxWidth: "28rem" }} >
